...
//import com.example.sasindu.R
//import com.example.sasindu.databinding.ActivitySignUpBinding
import com.example.firebasekotlin.Models.Customers
import com.example.firebasekotlin.R
import com.example.firebasekotlin.SignInActivity
            ...
            if(cusName.isEmpty() || cusEmail.isEmpty() || cusPhone.isEmpty() || cusPassword.isEmpty() || cusConfirPassword.isEmpty()){
                ...
                auth.createUserWithEmailAndPassword(cusEmail, cusPassword).addOnCompleteListener{
                    if(it.isSuccessful){
                        ...
                        val Customers : Customers = Customers(cusName, cusEmail,cusPhone, auth.currentUser!!.uid)
